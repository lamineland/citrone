...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('adminty/files\assets\icon\themify-icons\themify-icons.css') }}">
    <!-- ico font -->
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Your Email Address">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <img src="{{ asset('adminty/files\assets\images\auth\Logo-small-bottom.png') }}" alt="small-logo.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
